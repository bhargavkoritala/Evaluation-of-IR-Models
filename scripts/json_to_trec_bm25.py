...
def post(encoded_args,lang,iteration,qid):
    ...
    inurl = 'http://52.14.130.28:8983/solr/BM25/select?q='+encoded_args+'&defType=edismax&qf=text_en+text_de+text_ru&fl=id%2Cscore&wt=json&indent=true&rows=20'
...
def main():
    ...
    for line in f.readlines():
        ...
        post(encoded_args,lang,iteration,qid)
